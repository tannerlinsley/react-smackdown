...
const repoName = 'React Smackdown'
// TODO: Point this to your repo
const repo = 'react-tools/react-smackdown'
...
const docsPath = './src/docs' // will probably be '../docs'
        ...
        children: [
          {
            path: 'javascript',
            title: 'Javascript',
            markdownSrc: 'src/docs/syntax/javascript.md',
          },
          {
            path: 'ruby',
            title: 'Ruby',
            markdownSrc: 'src/docs/syntax/ruby.md',
          },
          {
            path: 'elixir',
            title: 'Elixir',
            markdownSrc: 'src/docs/syntax/elixir.md',
          },
        ],
      },
    ],
