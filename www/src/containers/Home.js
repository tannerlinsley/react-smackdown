  ...
  <SiteData
    render={({ repo, repoURL, repoName }) => (
      <Styles>
        ...
        <img src={logoImg} alt="" />
        <h1>{repoName}</h1>
        <h2>One markdown + syntax highlighting component to rule them all.</h2>
        <p>
          React Smackdown provides you a single component to parse, render, and syntax highlight any
          markdown string you can feed it.
        </p>
        <Cards>
          <Card to="/docs" background="#ff6073">
            Introduction
          </Card>
          <Card to="/examples/markdown" background="#efbb3c">
            Examples
          </Card>
        </Cards>
